...
class AttendanceModel {
  ...
  AttendanceModel copyWith({
    ...
    return AttendanceModel(
      ...
      authorizationDateCreated: authorizationDateCreated ?? this.authorizationDateCreated,
      authorizationDateLimit: authorizationDateLimit ?? this.authorizationDateLimit,
  ...
  Map<String, dynamic> toMap() {
    ...
    if(authorizationDateCreated != null){
      result.addAll({'authorizationDateCreated': authorizationDateCreated!.millisecondsSinceEpoch});
    }
    if(authorizationDateLimit != null){
      result.addAll({'authorizationDateLimit': authorizationDateLimit!.millisecondsSinceEpoch});
    }
    if(attendance != null){
    ...
    if(confirmedPresence != null){
      result.addAll({'confirmedPresence': confirmedPresence!.millisecondsSinceEpoch});
    }
    if(status != null){
  ...
  factory AttendanceModel.fromMap(Map<String, dynamic> map) {
    return AttendanceModel(
      id: map['id'],
      professional: map['professional'] != null ? UserProfileModel.fromMap(map['professional']) : null,
      procedure: map['procedure'] != null ? ProcedureModel.fromMap(map['procedure']) : null,
      patient: map['patient'] != null ? PatientModel.fromMap(map['patient']) : null,
      healthPlan: map['healthPlan'] != null ? HealthPlanModel.fromMap(map['healthPlan']) : null,
      authorizationCode: map['authorizationCode'],
      authorizationDateCreated: map['authorizationDateCreated'] != null ? DateTime.fromMillisecondsSinceEpoch(map['authorizationDateCreated']) : null,
      authorizationDateLimit: map['authorizationDateLimit'] != null ? DateTime.fromMillisecondsSinceEpoch(map['authorizationDateLimit']) : null,
      attendance: map['attendance'] != null ? DateTime.fromMillisecondsSinceEpoch(map['attendance']) : null,
      description: map['description'],
      confirmedPresence: map['confirmedPresence'] != null ? DateTime.fromMillisecondsSinceEpoch(map['confirmedPresence']) : null,
