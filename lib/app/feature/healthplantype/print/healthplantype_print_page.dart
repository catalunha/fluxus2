...
class HealthPlanTypePrintPage extends StatelessWidget {
  final List<HealthPlanTypeModel> modelList;
  const HealthPlanTypePrintPage({
    Key? key,
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (pw.Context context) => <pw.Widget>[
          pw.Header(
            level: 1,
            child: pw.Text('Relatório de Tipos de Planos de Saúde'),
          ),
          ...body(),
        ],
      ),
